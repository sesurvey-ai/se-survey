 ...
 * ⛔ คีย์กับช่วงค่าต้องตรงกับ AppearanceControls.tsx (ui_scale 80-140) · ไม่มีค่าที่จำไว้ = 100% ของเบราว์เซอร์ (16px) — user เคาะ 22/09/69 รอบ 2
...
if(s>=80&&s<=140)d.style.fontSize=(16*s/100)+'px';}catch(e){}`;

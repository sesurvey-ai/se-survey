...
// ── 5) คู่กรณี: คำนำหน้าเจ้าของรถ + ที่อยู่ผู้ขับขี่คู่กรณี 5 ส่วน (16/09/69) ──
{
  const cases: Array<[string, string, string, string, string, string]> = [
    ...
    ['37 ต.หนองห้าง อ.อุทุมพรพิสัย ศรีสะเกษ', '', 'หนองห้าง', '', '', '37 ต.หนองห้าง อ.อุทุมพรพิสัย ศรีสะเกษ'],   // มีแต่ช่องตำบล: ชื่อจังหวัดเปล่า ๆ ท้ายหางติดกับ อ. ไม่กระโดดไปหัว (เคส #513)
  ...
  check('driverAddressLine: อ./จ. ที่พิมพ์ปนถูกตัด (ส่งอำเภอ/จังหวัดมาด้วย) ไม่ต่อในข้อความ · กรุงเทพ → แขวง · ไม่ส่งมา = เหมือนเดิม',
    ...
    && driverAddressLine('37 ต.หนองห้าง อ.อุทุมพรพิสัย ศรีสะเกษ', '7', 'หนองห้าง') === '37 ม.7 ต.หนองห้าง อ.อุทุมพรพิสัย ศรีสะเกษ'
    && driverAddressLine('37 ต.หนองห้าง อ.อุทุมพรพิสัย ศรีสะเกษ', '7', 'หนองห้าง', 'อำเภออุทุมพรพิสัย', 'ศรีสะเกษ') === '37 ม.7 ต.หนองห้าง',
